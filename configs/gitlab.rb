...
gitlab_rails['trusted_proxies'] = ['192.168.0.1/16','172.16.0.1/12']
...
gitlab_rails['smtp_address'] = "mail-relay"
...
nginx['ssl_certificate'] = "/dev/null"
nginx['ssl_certificate_key'] = "/dev/null"
...
nginx['real_ip_trusted_addresses'] = ['192.168.0.0/16','172.16.0.0/12']
